<template>
  <div>
    <div id="map" />
    {{ getSelectedPermit.lat }}
    {{ getSelectedPermit.lng }}
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    async initMap() {
      const latLng = new kakao.maps.LatLng(this.getSelectedPermit.lat, this.getSelectedPermit.lng)
      ...
      new kakao.maps.Marker({
                position :latLng,
                title : this.getSelectedPermit.siteName ,
                map,
            });
    ...
    var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize);
        var markers = this.getSelectedPermit.siteList.map(function(i) {
